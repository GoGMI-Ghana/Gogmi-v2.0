...
const Partners = () => {
  ...
  const partners = [
    ...
    },
    {
      ...
      category: 'Partnership',
      project: 'IDEC & IMDEC',
      description: 'Great Minds Event Management has partnered with the Gulf of Guinea Maritime Institute (GoGMI) to deliver high-impact maritime conferences and strategic dialogues that foster collaboration among policymakers, security practitioners, industry leaders, academics, and development partners. Through this partnership, GoGMI has co-organised the International Defence Exhibition and Conference (IDEC) with the Ghana Armed Forces and the International Maritime Defence Exhibition and Conference (IMDEC) with the Ghana Navy. These flagship events have provided important platforms for advancing discussions on maritime security, defence cooperation, technological innovation, and sustainable Blue Economy development. By combining Great Minds Event Management's expertise in event execution with GoGMI's thought leadership and extensive maritime network, the partnership has strengthened regional dialogue, knowledge exchange, and strategic engagement on critical security and defence issues in Ghana and the wider Gulf of Guinea.',
      since: '2024',
    ...
    },
    {
      ...
      description: 'Maritimafrica partnered with the Gulf of Guinea Maritime Institute (GoGMI) as the official media partner for the launch of the Blue Mentorship Programme, an initiative designed to nurture the next generation of maritime and Blue Economy professionals across Africa. Through this partnership, Maritimafrica provided strategic media coverage and communications support to amplify the programme's reach, highlight mentorship opportunities, and showcase the importance of developing skilled leaders for the continent's maritime sector. The collaboration strengthened awareness of the programme while promoting knowledge sharing, professional development, and greater engagement among students, young professionals, and industry stakeholders',
      since: '',
    ...
    },
    {
      ...
      category: 'Partnership',
      project: 'IMSWG',
      description: 'The Kofi Annan International Peacekeeping Training Centre (KAIPTC) partnered with the Gulf of Guinea Maritime Institute (GoGMI) to advance regional dialogue and cooperation on maritime security through the hosting of the International Maritime Security Working Group (IMSWG) meetings at its facilities in Accra. By providing a platform for regular engagements, KAIPTC supported GoGMI in convening policymakers, security practitioners, academics, development partners, and maritime stakeholders to discuss emerging security challenges, share best practices, and develop collaborative approaches to enhancing maritime governance and stability in the Gulf of Guinea.',
      since: '',
